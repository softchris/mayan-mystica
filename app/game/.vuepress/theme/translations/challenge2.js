export default {
	en: {
		...
		guess: 'blue',
		welldone:
			'A buzzing sound surprises you, and a drone flies down to you, dropping a package into your lap. Truly great service! "Well done!" says the turtle. "You have discovered the second part of the temple\'s name! Now, dive in and recover the missing piece of this room."',
	...
	pt: {
		...
		guess: 'azul',
		welldone:
			'Um zumbido o surpreende e um drone voa até você, deixando cair um pacote no seu colo. Realment, um ótimo serviço! "Bom trabalho!" diz a tartaruga. "Você descobriu a segunda parte do nome do templo! Agora, mergulhe e recupere a peça que faltava desta sala."',
